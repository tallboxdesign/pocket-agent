...
export const SETTINGS_SCHEMA: SettingDefinition[] = [
  ...
  {
    key: 'agent.smartRouter',
    defaultValue: 'false',
    encrypted: false,
    category: 'agent',
    label: 'Smart Router',
    description: 'Classify incoming Telegram messages with a fast model to pick optimal mode, model, and tool set. Falls back to current behavior on error.',
    type: 'boolean',
  },
  {
    key: 'agent.smartRouterModel',
    defaultValue: 'claude-haiku-4-5-20251001',
    encrypted: false,
    category: 'agent',
    label: 'Smart Router Model',
    description: 'Model used to classify incoming messages (fast + cheap — Haiku recommended)',
    type: 'string',
  },
  {
    key: 'agent.researchAgentModel',
    defaultValue: 'claude-sonnet-4-6',
    encrypted: false,
    category: 'agent',
    label: 'Research Agent Model',
    description: 'Model used by each parallel sub-agent during deep research',
    type: 'string',
  },
  {
    key: 'agent.researchSupervisor',
    defaultValue: 'false',
    encrypted: false,
    category: 'agent',
    label: 'Research Supervisor',
    description: 'After research sub-agents finish, run a quality review. Critical findings are retried once with targeted feedback.',
    type: 'boolean',
  },
  {
    key: 'agent.researchSupervisorModel',
    defaultValue: 'claude-sonnet-4-6',
    encrypted: false,
    category: 'agent',
    label: 'Research Supervisor Model',
    description: 'Model used for the research quality review step',
    type: 'string',
  },
  ...
  {
    key: 'linkedin.postNowFirstDelaySec',
    defaultValue: '10',
    encrypted: false,
    category: 'linkedin',
    label: 'Post Now First Delay (sec)',
    description: 'Delay before the first Post Now item becomes eligible to publish',
    type: 'number',
  },
  {
    key: 'linkedin.postNowHotCount',
    defaultValue: '5',
    encrypted: false,
    category: 'linkedin',
    label: 'Post Now Hot Count',
    description: 'How many Post Now items stay in the hot near-term cluster',
    type: 'number',
  },
  {
    key: 'linkedin.postNowHotWindowMin',
    defaultValue: '15',
    encrypted: false,
    category: 'linkedin',
    label: 'Post Now Hot Window (min)',
    description: 'Time window used to spread the hot Post Now cluster',
    type: 'number',
  },
  {
    key: 'linkedin.postNowPriorityCount',
    defaultValue: '10',
    encrypted: false,
    category: 'linkedin',
    label: 'Post Now Priority Count',
    description: 'How many Post Now items stay prioritized before normal queue expansion takes over',
    type: 'number',
  },
  {
    key: 'linkedin.postNowPriorityWindowMin',
    defaultValue: '120',
    encrypted: false,
    category: 'linkedin',
    label: 'Post Now Priority Window (min)',
    description: 'Outer time window used to spread prioritized Post Now items after the hot cluster',
    type: 'number',
  },
  {
